...
public class SmartBearSteps {
    ...
    public void user_clicks_on_button(String button) {
        switch (button) {
            case "Check All":
                smartBearWebOrdersPage.checkAllBox.click();
                break;
    ...
    public void user_clicks_on_menu_item(String orderMenuItem) {
        switch (orderMenuItem) {
            case "Order":
                for (int i = 0; i < smartBearWebOrdersPage.webOrdersMenuItems.size(); i++) {
                    smartBearWebOrdersPage.webOrdersMenuItems.get(i).click();
                }
        }
    }
