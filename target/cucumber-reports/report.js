...
formatter.match({
  "location": "SmartBearSteps.user_enters_as_quantity(Integer)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "SmartBearSteps.user_enters_all_address_information()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user clicks on\"View all orders\" menu items",
  "keyword": "And "
});
formatter.match({
  "location": "SmartBearSteps.userClicksOnMenuItems(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "SmartBearSteps.user_should_see_their_order_displayed_in_the_table(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "SmartBearSteps.validate_all_orders_are_deleted_from_the(String)"
});
formatter.result({
  "status": "passed"
});
